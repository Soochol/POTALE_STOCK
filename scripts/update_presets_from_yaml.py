...
def print_conditions_table(
    ...
    print(
        ...
        + "│"
        + f"{block2.get('entry_surge_rate', block1['entry_surge_rate']):>6.1f}%".center(
            12
        )
        + "│"
        + f"{block3.get('entry_surge_rate', block1['entry_surge_rate']):>6.1f}%".center(
            12
        )
        + "│"
    ...
    print(
        ...
        + (
            "   예".center(12)
            if block1.get("entry_high_above_ma", True)
            else "  아니오".center(12)
        )
        + "│"
        + (
            "   예".center(12)
            if block2.get("entry_high_above_ma", True)
            else "  아니오".center(12)
        )
        + "│"
        + (
            "   예".center(12)
            if block3.get("entry_high_above_ma", True)
            else "  아니오".center(12)
        )
        + "│"
        + (
            "   예".center(12)
            if block4.get("entry_high_above_ma", True)
            else "  아니오".center(12)
        )
        + "│"
    ...
    print(
        ...
        + "│"
        + f"{block2.get('entry_max_deviation_ratio', block1['entry_max_deviation_ratio']):>6.1f}%".center(
            12
        )
        + "│"
        + f"{block3.get('entry_max_deviation_ratio', block1['entry_max_deviation_ratio']):>6.1f}%".center(
            12
        )
        + "│"
    ...
    print(
        ...
        + "│"
        + f"{block2.get('entry_min_trading_value', block1['entry_min_trading_value']):>5.0f}억".center(
            12
        )
        + "│"
        + f"{block3.get('entry_min_trading_value', block1['entry_min_trading_value']):>5.0f}억".center(
            12
        )
        + "│"
    ...
    print(
        ...
        + "│"
        + format_months(
            block2.get("entry_volume_high_months", block1["entry_volume_high_months"])
        ).center(12)
        + "│"
        + format_months(
            block3.get("entry_volume_high_months", block1["entry_volume_high_months"])
        ).center(12)
        + "│"
    ...
    print(
        ...
        + "│"
        + f"{block2.get('entry_volume_spike_ratio', block1['entry_volume_spike_ratio']):>6.1f}%".center(
            12
        )
        + "│"
        + f"{block3.get('entry_volume_spike_ratio', block1['entry_volume_spike_ratio']):>6.1f}%".center(
            12
        )
        + "│"
    ...
    print(
        ...
        + "│"
        + format_months(
            block2.get("entry_price_high_months", block1["entry_price_high_months"])
        ).center(12)
        + "│"
        + format_months(
            block3.get("entry_price_high_months", block1["entry_price_high_months"])
        ).center(12)
        + "│"
    ...
    print(
        ...
        + "│"
        + exit_types.get(
            block2.get("exit_condition_type", "ma_break"), "MA돌파"
        ).center(12)
        + "│"
        + exit_types.get(
            block3.get("exit_condition_type", "ma_break"), "MA돌파"
        ).center(12)
        + "│"
        + exit_types.get(
            block4.get("exit_condition_type", "ma_break"), "MA돌파"
        ).center(12)
        + "│"
        + " 종료 조건 방식".ljust(32)
        + "│"
