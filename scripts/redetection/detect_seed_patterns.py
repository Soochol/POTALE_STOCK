...
Strict conditions로 high-quality seed patterns를 탐지하고 DB에 저장
"""
import argparse
import sys
    ...
    def _create_seed_pattern(
        ...
        for block in blocks:
            feature = BlockFeatures(
                ...
                duration_candles=block.duration or 0,
                low_price=block.lowest_price or 0.0,
                high_price=block.highest_price or 0.0,
                peak_price=block.peak_price or 0.0,
                peak_date=block.peak_date or block.started_at,
                min_volume=block.min_volume or 0,
                max_volume=block.max_volume or 0,
                peak_volume=block.peak_volume or 0,
                avg_volume=block.avg_volume or 0
            )
