...
from src.application.services.pattern_seed_detector import PatternSeedDetector
from src.application.services.pattern_redetector import PatternRedetector
...
class DetectPatternsUseCase:
    ...
    def execute(
        ...
        stocks_with_indicators = calculator.calculate(
            stocks=stocks,
            ma_period=seed_condition.entry_ma_period,
            exit_ma_period=seed_condition.exit_ma_period,
            volume_months=seed_condition.volume_high_months,
            new_high_months=seed_condition.price_high_months
        )
