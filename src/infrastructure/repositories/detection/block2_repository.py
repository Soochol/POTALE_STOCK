...
class Block2Repository(
    ...
    def _model_to_entity(self, model: Block2DetectionModel) -> Block2DetectionEntity:
        ...
        entity = Block2DetectionEntity(
            ...
            prev_block_id=model.prev_block1_id,
            prev_block_peak_price=model.prev_block1_peak_price,
            prev_block_peak_volume=model.prev_block1_peak_volume,
    ...
    def find_by_pattern_and_condition(
        ...
        """
        특정 패턴의 특정 조건(seed/redetection) Block2 조회
